...
The data-cleaning algorithm removes irrelevant constituents by applying a rule-based method. It filters syntactic constructions associated with `"baca juga"` based on how they are typically constructed within news content. More on syntactic constructions of `"baca juga"` constituents can be found [here](https://github.com/alanindra/baca-juga-cleaner/blob/main/baca_juga_syntax.md). More detailed analysis can be found [here](https://github.com/alanindra/baca-juga-cleaner/blob/main/analysis.ipynb).
